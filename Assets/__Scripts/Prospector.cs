...
public class Prospector : MonoBehaviour
{
    ...
    public float reloadDelay = 2f; //2 sec delay
    ...
    void Start()
    {
        ...
        drawPile = ConvertListToCardProspectors(deck.cards);

        LayoutGame();
    }
        List<CardProspector> ConvertListToCardProspectors(List<Card> lCD)
    {
    ...
    void SetTableauFaces()  // This turns cards in the Mine face-up or face-down
    {
    ...
    public void CardClicked(CardProspector cd)
    {
        ...
        switch (cd.state)
        {
            ...
            case eCardState.tableau:
                ...
                SetTableauFaces(); //update tableu card faceups
